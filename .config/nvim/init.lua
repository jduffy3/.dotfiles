...
require("lazy").setup({
	...
	-- this is equivalent to require('gitsigns').setup({ ... })
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- call hierarchy
					map("<leader>I", require("telescope.builtin").lsp_incoming_calls, "[I]ncoming [C]alls")
					map("<leader>O", require("telescope.builtin").lsp_outgoing_calls, "[O]utgoing [C]alls")
					map("gd", require("telescope.builtin").lsp_definitions, "[G]oto [D]efinition")
					map("gr", require("telescope.builtin").lsp_references, "[G]oto [R]eferences")
					map("gI", require("telescope.builtin").lsp_implementations, "[G]oto [I]mplementation")
					-- Jump to the type of word under cursor; not where it was defined
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>bc", builtin.commands, { desc = "Lists [B]uiltin [C]ommands" })
			...
			vim.keymap.set(
				...
				"<leader>l",
				builtin.treesitter,
				{ desc = "[L]ist function names, variables from treesitter " }
			)
...
vim.opt.showmode = false -- dont show mode its in the status line
...
vim.keymap.set("n", "<leader>e", vim.diagnostic.open_float, { desc = "Open floating diagnostic [E]rror messages" })
...
vim.keymap.set("n", "]Q", ":clast<CR>", { desc = "[Q]uickfix :c[l]ast" })
